...
function App () {
  ...
  return (
    <div className="App">
      <div className="bg-slate-900 text-slate-200 w-full h-auto font-cascadia ">
        <header>
          { screenWidth < 1024 && <div onClick={() => toggleMenu()} className="fixed top-0 left-auto right-0 z-50"><BurgerMenu menuState={menuMobileIsOpen} /></div>}
