...
import { SZLogo } from '../Logos/SZLogo.jsx'
    ...
    <nav {...props} className={'fixed h-full bg-slate-800 z-40 right-0 left-auto ' + (isActive === false ? 'hidden' : 'block')}>
      <ul className="flex flex-col w-80 h-full">
        <div className="w-full h-20">
          <p className="ml-4 h-full flex items-center"><SZLogo className="mr-4" circleColor="fill-slate-200" textColor="fill-slate-900" />Sergio Zabala</p>
        </div>
