...
export const ChangeIdiom = () => {
  ...
  return (
    <div className="flex items-center">
          {(localStorage.getItem('lng') === 'es' || localStorage.getItem('lng') === null) && <div className="flex flex-row"><div className="mr-4 flex items-center"><EsIcon className="rounded-full w-5 h-5 mr-2" />Es</div><button className="mr-4 flex items-center grayscale transition hover:grayscale-0" onClick={changeIdiomEn}><EnIcon className="rounded-full w-5 h-5 mr-2" />En</button></div>}
