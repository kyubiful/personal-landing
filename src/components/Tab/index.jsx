...
export const Tab = ({ to, children, ...props }) => {
  ...
  return (
    <li className={ match ? 'lg:border-r border-slate-700 h-auto' : 'lg:border-r border-slate-700 shadow-[inset_0_-1px_0_#334155] h-auto hover:bg-slate-500 transition'}>
