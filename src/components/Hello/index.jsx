  ...
  return (
    <div className="pt-2 pb-2 lg:pt-12 lg:pb-2 min-h-screen h-full flex flex-col justify-between">
      ...
      <div className="flex flex-col justify-center items-center content-center h-auto max-w-4xl w-full m-auto pt-2 pb-2">
        <div>
          <p className="text-xl md:text-2xl lg:text-2xl animate-fade-in">Hola <span className="text-3xl md:text-4xl lg:text-5xl inline-block animate-waving-hand [animation-delay:4.5s]">👋🏻</span>, me llamo</p>
          ...
          <p className="text-xl md:text-2xl lg:text-2xl text-right animate-fade-in">Desarollador Web</p>
