...
export const ProjectCardMobile = ({ className, index, name, text, gitHubUrl, webUrl, technologies = [], imageUrl }) => {
  return (
    <div className={ 'flex flex-col h-96 justify-center items-center ' + className}>
      ...
      <div className="max-w-sm md:max-w-lg relative w-full group p-1 h-52 md:h-96">
      ...
      <div className="flex flex-col items-start justify-center w-auto -mt-20 max-w-sm md:max-w-md items-center p-4">
