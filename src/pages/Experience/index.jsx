      ...
      <div className="h-40 flex flex-col justify-between">
        ...
        <div className="flex flex-col h-auto max-w-5xl w-full m-auto pr-6 pl-6">
          <div className="flex flex-col justify-between mb-5 lg:flex-row gap-10 lg:gap-0">
            ...
            <div className="flex justify-start flex-col items-start gap-2 h-full animate-fade-in">
              <h3 className="mb-10 mt-5 text-lg lg:text-2xl md:text-2xl max-w-md">Vida laboral</h3>
              <div className="flex justify-center items-center gap-2 max-h-80 h-full animate-fade-in">
